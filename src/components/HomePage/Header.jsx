...
export const Header = () => {
  ...
  const handleSearch = (e) => {
    ...
    // Remove or keep modalCloseTimestamp based on the match
    // if (!matchFound) {
    //   localStorage.removeItem("modalCloseTimestamp");
    //   window.location.reload();
    // }
  ...
  return (
    <>
      ...
      <nav
        className={`navbar navbar-expand-lg mb-0 pt-2 ${isScrolled ? "header-scrolled" : ""
          }  ${isMenuOpen ? "show" : ""}`}
        style={{
          width: "100%",
          ...
          backgroundImage: "linear-gradient(337deg,#3533cd 0%,#000000 100%)",
          top: "0",
          paddingTop: "10px",
        }}
      >
        <div className="container-fluid">
          ...
          <div
            ...
            id="navbarNav"
          >
            <ul className="navbar-nav justify-content-end w-100 align-items-center gap-3 ">
              ...
              {main || blog || privacy || (
                <>
                  <li className="d-md-block d-none" style={{ width: "24%" }}>
                    <div className="">
                      <Select
                        styles={customStyles}
              ...
              <li className="nav-item my-3 phonebtn">
                <a
                  href="tel:8218073585 "
                  style={{ fontSize: "14px" }}
