              ...
              <div class="col-md-3">
                <div class="footer-widget">
                  ...
                  <ul className="m-0 p-0 d-flex align-items-center ms-1 mt-2 gap-3 socialicons">
                    <li>
                      <a
                        href="https://instagram.com/mytravelsarthi?igshid=OGQ5ZDc2ODk2ZA=="
                        target="_blank"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.facebook.com/profile.php?id=61552990767072"
                        target="_blank"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.youtube.com/@Mytravelsarthi"
                        target="_blank"
                      >
